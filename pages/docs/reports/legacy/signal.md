...
- The correlation event can be [broken down by property](/docs/reports/overview#breakdowns). To do this, select **+ Breakdown** and select the property to break the data down by.
- The correlation event can be [filtered by property](/docs/reports/overview#event-inline-filters). To do this, select **+ Filter** and select the property and property value you want to filter by.
